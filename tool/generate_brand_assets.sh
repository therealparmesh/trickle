...
resize "$launch" 48 "$root/android/app/src/main/res/mipmap-mdpi/ic_launcher.png"
resize "$launch" 72 "$root/android/app/src/main/res/mipmap-hdpi/ic_launcher.png"
resize "$launch" 96 "$root/android/app/src/main/res/mipmap-xhdpi/ic_launcher.png"
resize "$launch" 144 "$root/android/app/src/main/res/mipmap-xxhdpi/ic_launcher.png"
resize "$launch" 192 "$root/android/app/src/main/res/mipmap-xxxhdpi/ic_launcher.png"
...
resize "$launch" 288 "$root/assets/brand/trickle-launch.png"
