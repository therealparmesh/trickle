...
- Subscriptions: complete catalog previews before subscription and after in-place unsubscribe, concurrent row-level catalog subscriptions, catalog recognition of public podcasts imported through OPML, public/private direct URLs, query/path credentials, website discovery, malformed feeds, redirects, UTF-8/UTF-16 OPML import, separate OPML exports for podcasts, feeds (RSS and YouTube), and all subscriptions, backup/restore, and unsubscribe cleanup
