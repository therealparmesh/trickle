...
- Video: foreground in-app playback, minimize/expand/close/reopen, pause on app backgrounding, yout-ube-first loading, official YouTube fallback only after failure, unmodified official-player ads, network loss, and no reload while navigating
