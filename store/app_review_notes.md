...
Background audio is active only while podcast audio is playing. App-private episode downloads may continue through the operating system's download scheduler. trickle does not access the user's Photos or media library.
...
trickle is a general-purpose client for content selected by the user. Podcast search uses Apple's public catalog. The app does not host, sell, or modify third-party audio or articles.
